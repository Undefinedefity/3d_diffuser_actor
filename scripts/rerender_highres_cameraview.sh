...
# 修改数据路径到外置硬盘
EXTERNAL_DRIVE=/media/def/WD_BLACK/GNFactor
SPLIT=train
...
RAW_SAVE_PATH=${EXTERNAL_DRIVE}/data/peract/raw_highres/${SPLIT}
PACKAGE_SAVE_PATH=${EXTERNAL_DRIVE}/data/peract/packaged_highres/${SPLIT}
...
python data_preprocessing/rearrange_rlbench_demos_old.py --root_dir ${EXTERNAL_DRIVE}/data/peract/raw_highres/${SPLIT}
